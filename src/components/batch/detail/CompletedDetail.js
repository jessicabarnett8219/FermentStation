      ...
      <React.Fragment>
        <div className="container padding-horizontal-m sticky-footer-clear">
          ...
          <ul className="font-size-xl ul">
            ...
            <li className="no-margin-horizontal"><strong>Completed On </strong><Moment format="MM/DD/YY">{this.props.completeDate}</Moment></li>
              ...
              <ul className="font-size-xl">
                {
                  this.props.starterIngredients.map(i => {
                    return <li className="no-margin-vertical" key={i.id}>{i.amount} {i.measurement} {i.ingredient.name} </li>
                  })
                }
              </ul></li>
            ...
            <li className="no-margin-horizontal"><strong>Rating </strong>{this.props.rating === "positive" ? <i className="fas fa-thumbs-up fa-lg padding-horizontal-xs"></i> : this.props.rating === "negative" ? <i className="fas fa-thumbs-down fa-lg padding-horizontal-xs"></i> : null}
